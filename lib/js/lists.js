...
var FriendList = {
    ...
    init : function(user){      
        $.ajax({
            type: 'GET',
            url: "https://graph.facebook.com/" + userObject.uid + "/friends&access_token="+ accessToken,
            ...
            success: 
                function(json){
                    console.log('DUNN');
                    FriendList.clear();
                    //FriendList.addFriends(json.data.sort(sortByName));
                    FriendList.addFriends(json);
